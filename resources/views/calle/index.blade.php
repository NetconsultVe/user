...
<div class="row">
   <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
            ...
            <button type="button" class="btn btn-primary" id="btnAddCalle">Agregar Calle</button>
            </div>
         </div>
   </div>
</div>
<div class="row">
   <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
         <div class="panel-heading">Registros de Calles</div>
               <div class="panel-body"> 
                     <table id="GridCalle" class="table" cellspacing="0">
                  <thead>
                     <tr>
                        <th>Nombre Calle</th>
                        <th>Cédula</th>
...
@include('calle.Insert')
@include('calle.Update')

@endsection

@section('script')
<script type="text/javascript" src="{{ asset('js/dist/netInit.js?ver=0.00003&jsModule=jsCalle&cssModule=') }}"></script>
@endsection
